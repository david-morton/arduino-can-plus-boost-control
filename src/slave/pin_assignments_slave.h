...
constexpr uint8_t PIN_BOOST_SOLENOID_BANK1 = 5;
constexpr uint8_t PIN_BOOST_SOLENOID_BANK2 = 6;
constexpr uint8_t PIN_MUX_S1               = 7;
constexpr uint8_t PIN_MUX_S2               = 8;
constexpr uint8_t PIN_MUX_S3               = 9;
