...
#define ALARM_BUZZER_FREQUENCY_HZ 8000              // Frequency of the buzzer sound in Hertz
#define ALARM_BUZZER_WARNING_ON_DURATION_MS 100    // Duration of the warning buzzer sound in milliseconds
